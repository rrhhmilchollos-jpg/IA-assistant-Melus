...
async def github_login(request: Request):
    ...
    external_url = os.environ.get('EXTERNAL_URL', 'https://motor-no-chat.preview.emergentagent.com')
...
async def github_callback(request: Request, code: str, state: str):
    ...
    frontend_url = os.environ.get('FRONTEND_URL', 'https://motor-no-chat.preview.emergentagent.com')
...
---
Generated on {utc_now().strftime('%Y-%m-%d %H:%M:%S')} by [Assistant Melus](https://motor-no-chat.preview.emergentagent.com)
"""
